...
SECRET_KEY = 'a%n%y)#&amp;8@%#%$v-t^0w*pt0lx74o3=(8-i5uj65i_jvdp-d+m'
...
FOURSQUARE_CALLBACK_URL = os.getenv('FOURSQUARE_CALLBACK_URL')
...
EMAIL_SUBJECT_PREFIX="[whereami] "
SERVER_EMAIL="whereami_server@doismellburning.co.uk"
